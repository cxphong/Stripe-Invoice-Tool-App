...
class CountryListPicker extends StatefulWidget {
  ...
  void setSelectedCountry(Countries country) {
    print('xxx setSelectedCountry');
    print(state);
    state?.updateCountry(country);
    print(state);
  }

  _CountryListPickerState? state;
...
class _CountryListPickerState extends State<CountryListPicker> {
  ...
  Widget build(BuildContext context) {
    ...
    print('yyy ' + selectedCountry!.name.official);
  ...
  void updateCountry(Countries _selectedCountry) {
    selectedCountry = countries.firstWhere(
        (Country e) => (e.iso_3166_1_alpha3.toUpperCase() ==
            _selectedCountry.iso_3166_1_alpha3.toUpperCase()),
        orElse: () => countries[0]);
    print('yyy + ' + selectedCountry!.name.official);
    // setState(() {});
  }
